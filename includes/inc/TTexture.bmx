...
EndRem	
	...
	' #####################################
	Function LoadPixmap:TTexture(pmap:TPixmap,flags:Int,frame_width:Int,frame_height:Int,first_frame:Int,frame_count:Int,tex:TTexture=Null)
	...
	Method BackBufferToTex(mipmap_no:Int=0,frame:Int=0,fastinvert:Int=True)
        ...
        If flags&128=0 ' normal texture
            ...
            Else
                pixmap = ApplyAlpha(GrabPixmap(x,y,width,height)) ' should always be in PF_RGBA8888
